<x-app>
    <title>FIDELISOR - Customer Gift</title>
    ...
    <div class="card card-body border-0 shadow mb-5 mt-5">
       ...
       <div class="p-2 col-xl-2 col-md-3 col-sm-3">
         ...
         <li><a class="dropdown-item" href="{{route("gifts.customer",$s->id)}}">{{$s->nomStore}}</a></li>
         @endforeach
           </ul>
         </div>
     </div>  
                ...
                <tr>
                    ...
                    <td><div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            ...
                            <form action="{{route("gifts.destroyProfile",[$store->id,$profile->id])}}" method="post">
                                @csrf
                                @method("DELETE")
