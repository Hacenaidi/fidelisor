<x-app>
    <title>FIDELISOR - Edit Gift</title>
    ...
    <div class="card card-body border-0 shadow mb-5 mt-5 mx-auto rounded" style="width: 60%;">
        <h3 class="text-info">
            ...
            <form action="{{route("gifts.update",$gift->id)}}" method="post" enctype="multipart/form-data" class="d-flex mt-2 mx-2">
                @csrf
                @method("PUt")
                <div class="col mb-2">
                    <div class="mb-3">
                        <label for="">Selected store</label>
                            <select
                               ...
                               name="id_store"
                                id=""
                            >
                                <option selected value="{{$gift->store->id}}">{{$gift->store->nomStore}}</option>
                    </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            value="{{old("namecard",$gift->namecard)}}"
                        />
                    ...
                    <div class=" mb-3">
                        ...
                        <textarea class="form-control" name="description" rows="3">{{old("description",$gift->description)}}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select  name="currency" class="form-select form-select-lg">
                            <option value="{{$gift->currency}}" selected>{{$gift->currency}}</option>
                      ...
                      <div class=" mb-3">
                        ...
                        <input
                            ...
                            aria-describedby="helpId"
                            value="{{old("validite",$gift->validite)}}"
                        />
                      ...
                      <div class="mb-3">
                        ...
                        <input
                            ...
                            id=""
                            class="form-control"
                            placeholder="Enter Gift Card  Quota"
                            aria-describedby="helpId"
                            value="{{old("nb_max",$gift->nb_max)}}"
                        />
                      ...
                      <div class="mb-3">
                        ...
                        <select  name="expiration" class="form-select form-select-lg">
                            <option value="{{$gift->expiration}}">{{$gift->expiration}} Day</option>
                      ...
                      <div class="input-group mb-3">
                        <label for="">Gift Card Image </label>
            ...
            <div class="mb-3 float-end">
                <a href="{{route("gifts.index",$gift->store->id)}}" class="btn btn-gray-800" >back</a>
